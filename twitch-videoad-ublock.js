//Whitespace is removed for the ublock origin script - also indented
...
(function() {
        ...
        constructor(twitchBlobUrl) {
            ...
            this.onmessage = function(e) {
                if (e.data.key == 'ShowAdBlockBanner') {
                    ...
                    adBlockDiv.P.textContent = 'Bloqueando anuncios...';
    ...
    function hookWorkerFetch() {
        console.log('Twitch adblocker se está ejecutando.');
        var realFetch = fetch;
